...
Returns the Customer object after successful customer creation. Raises [an error](https://docs.stripe.com/api/customers/create.md#errors) if create parameters are invalid (for example, specifying an invalid source).
